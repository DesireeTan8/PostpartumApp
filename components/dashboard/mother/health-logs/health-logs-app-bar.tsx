...
export function HealthLogsAppBar() {
    ...
    return (
        <div className="relative mx-auto max-w-[1200px] shrink-0">
            <div className={`${HEADER_MOBILE_HEALTH_LOGS_MATCH_ROW_CLASSNAME} lg:hidden`}>
                <h1
                ...
                <label
                    className={`${HEADER_MOBILE_HEALTH_LOGS_MATCH_SEARCH_LABEL_BASE_CLASSNAME}${healthLogsSearchExpanded
                            ? ` ${HEADER_MOBILE_HEALTH_LOGS_MATCH_SEARCH_LABEL_EXPANDED_CLASSNAME}`
                            : " max-lg:hidden"
                        }`}
                    onClick={() => {
                ...
                >
                    <button
                        type="button"
                        className={`inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border-0 bg-transparent text-[#4d5563] hover:bg-[#eef5f5] hover:text-brand ${healthLogsSearchExpanded ? "bg-[#eaf6f5] text-brand" : ""
                            }`}
                        onClick={() => {
